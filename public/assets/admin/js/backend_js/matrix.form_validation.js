$(document).ready(function(){
	...
	//add trustedby form validation
	$("#add_trustedby").validate({
		rules:{
			name:{
				required:true
			},
	...
	//edit trustedby form validation
	$("#edit_trustedby").validate({
		rules:{
			name:{
				required:true
			},
