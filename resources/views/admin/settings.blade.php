...
<div id="content">
    <div id="content-header">
        <div id="breadcrumb"> <a href="{{ url('/admin/dashboard') }}" title="Go to Home" class="tip-bottom"><i class="icon-home"></i> Home</a>  <a href="#" class="current">Settings</a> 
        </div>
                            ...
                            <form class="form-horizontal" method="post" action="{{ url('/admin/update-pwd') }}" name="password_validate" id="password_validate" novalidate="novalidate">{{ csrf_field() }}
                                ...
                                <div class="control-group">
                                    <div class="form-actions">
                                        <input type="submit" value="Update Password" class="btn btn-success" style="float: center">
                                    </div>
                                </div>
                            </form>
                        </div>
                        ...
                        <div class="widget-content nopadding">
                            <form class="form-horizontal" method="post" action="" name="" id="" novalidate="novalidate">{{ csrf_field() }}
                                <div class="control-group">
                                    ...
                                    <div class="controls">
                                        <input type="file" name="new_pwd" /><br>
                                    </div>
                                </div>
                                <div class="control-group">
                                    <label class="control-label">Change Logo</label>
                                    <div class="controls">
                                        <input type="file" name="confirm_pwd" />
                                    </div>
                                </div>
                                <div class="control-group">
                                    <div class="form-actions">
                                        <button type="submit" value="Update Password" class="btn btn-success" style="float: center"> Update</button>
                                    </div>
                                </div>
                            </form>
                        </div>
