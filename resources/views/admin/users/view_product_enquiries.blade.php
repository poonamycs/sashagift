            ...
            <table class="table table-bordered data-table">
              ...
              <tbody>
                ...
                <tr class="gradeX">
                  ...
                  <td style="text-align:center;">{{ $enquiry->phone }}</td>
                  <td>{{ $enquiry->product->product_name }}</td>
                  <td>{{ $enquiry->message }}</td>

                  <td style="text-align:center;">
                    <a href="{{ url('admin/delete-enquiry-product/'.$enquiry->id) }}" onclick="return confirm('Are you sure?')" class="btn btn-danger btn-mini">Delete</a>
                 </td>
                </tr>
                @endforeach
