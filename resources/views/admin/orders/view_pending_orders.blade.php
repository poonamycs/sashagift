...
<div id="content">
  <div id="content-header">
    <div id="breadcrumb"> <a href="{{ url('admin/dashboard') }}" title="Go to Home" class="tip-bottom"><i class="icon-home"></i> Home</a> <a href="#">Pending Orders</a> <a href="#" class="current">View Pending Orders</a> </div>
    <h1>Pending Orders Section</h1>
