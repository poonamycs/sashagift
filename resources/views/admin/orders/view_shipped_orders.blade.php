...
<div id="content">
  <div id="content-header">
    <div id="breadcrumb"> <a href="{{ url('admin/dashboard') }}" title="Go to Home" class="tip-bottom"><i class="icon-home"></i> Home</a> <a href="#">Shipped Orders</a> <a href="#" class="current">View Shipped Orders</a> </div>
    <h1>Shipped Orders Section</h1>
