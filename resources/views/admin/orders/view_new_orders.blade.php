...
<div id="content">
  <div id="content-header">
    <div id="breadcrumb"> <a href="{{ url('admin/dashboard') }}" title="Go to Home" class="tip-bottom"><i class="icon-home"></i> Home</a> <a href="#">New Orders</a> <a href="#" class="current">View New Orders</a> </div>
    <h1>New Orders Section</h1>
