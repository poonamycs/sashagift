          ...
          <div class="widget-content nopadding">
            <form enctype="multipart/form-data" class="form-horizontal" method="post" action="{{ url('/admin/edit-banner/'.$eid) }}" name="edit_banner" id="edit_banner" novalidate="novalidate"> {{ csrf_field() }}
              ...
              <div class="control-group">
                ...
                <div class="controls">
                  <textarea name="description" id="body" class="textarea_editor" rows="5" style="width: 65%">{{ $bannerDetails->description }}</textarea>
                </div>
              </div>
              <div class="control-group">
              ...
              <div class="control-group">
                ...
                <div class="controls">
                  ...
                  @if(!empty($bannerDetails->image))
                  <img style="height: 50px;" src="{{ asset('assets/admin/images/frontend_images/banners/'.$bannerDetails->image) }}">
                  @endif<br>
