              ...
              <tbody>
                ...
                <tr class="gradeX">
                  ...
                  <td>
                    ...
                    <img src="{{ asset('/images/backend_images/products/small/'.$product->image) }}" style="height: 50px;">
                    @endif
                  </td>

                  <td style="text-align: center;">@if($product->admin_approved==1)<span style="color: green; font-weight: bold;">Yes</span>@else<span style="color: red; font-weight: bold;">No</span>@endif
                  </td> 
                  ...
                  <td class="text-center">
                    ...
                    <a onclick="return confirm('Are you sure you want to delete this Product?');" href="{{ url('/admin/delete-product/'.$pid) }}" class="btn btn-danger" title="Delete product"><i class="fa fa-trash"></i></a>
                 </td>
                </tr>
